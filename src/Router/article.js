...
router.get("/", (req,res) => {
    ...
    try {
        // notFoundErrorFunc(articleCategory, "게시판 종류")
        inputErrorFunc(categoryIdx, "게시판 종류", regArticleCategory)
...
// 게시글 좋아요
router.post("/:articleIdx/article-like", (req,res) => {
    const {articleIdx} = req.params
    const {userIdx} = req.session
